  ...
  return (
    <Grid item mt={{ xs: 2, md: 0 }} xs={12} md={6}>
      <Typography variant='h6' color={"cyan"}>
        Greduate Apprenece Trainee <Typography component={'span'} color={"gray"}>@Tata Motors</Typography>
      </Typography>
      <Typography variant='caption'>Sanand, Gujarat, India // <Typography component={'span'} variant='caption' color={"cyan"}>July 2022 - Sptember 2022</Typography></Typography>
      <Typography variant='subtitle2' color={'white'}>Key Responsibilites : </Typography>
      <List>
        <Typography variant='subtitle2' component={"li"} >
          <Typography variant='subtitle2' color={'cyan'} component={'span'}>☀︎</Typography> Handling Last manufatuing operations in Tata motors. In which operations like handling production line and maintaing<Typography variant='subtitle2' color={'white'} component={'span'}> Speed of production</Typography>.
        </Typography>
        <Typography variant='subtitle2' component={"li"} >
...
const Exp2 = () => {
  return (
    <Grid item mt={{ xs: 4, md: 0 }} xs={12} md={6}>
      ...
      <Typography variant='caption'>Ahmedabad, Gujarat, India // <Typography component={'span'} variant='caption' color={"cyan"}>July 2022 - Sptember 2022</Typography></Typography>
      <Typography variant='subtitle2' color={'white'}>Key Responsibilites : </Typography>
      <List>
        <Typography variant='subtitle2' component={"li"} >
...
const Edu = () => {
  return (
    <Container maxWidth="lg" sx={{
      ...
      <Grid container>
        <EduCom name="12th Science" place="Purohit Science school" location="Jamnagar, Gujarat, India" timeSpan="July 2022 - Sptember 2022" />
        <EduCom name="Bachelor of Electrical Engineering" place="Government Engineering College" location="Rajkot, Gujarat, India" timeSpan="July 2022 - Sptember 2022" />
